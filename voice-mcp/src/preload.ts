...
contextBridge.exposeInMainWorld(
  'electron',
  {
    ...
    config: {
      ...
      getTranscriptionConfig: () => ipcRenderer.invoke('config:getTranscription'),
      setTranscriptionConfig: (config: any) => ipcRenderer.invoke('config:setTranscription', config),
      updateTranscriptionConfig: (updates: any) => ipcRenderer.invoke('config:updateTranscription', updates),
      getTranscriptionProvider: () => ipcRenderer.invoke('config:getTranscriptionProvider'),
